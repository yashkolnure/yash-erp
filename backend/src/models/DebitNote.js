...
const debitNoteSchema = new Schema({
    ...
    vendor_id: { type: Types.ObjectId, ref: 'Vendor', required: true },
    purchase_order_id: { type: Types.ObjectId, ref: 'PurchaseOrder' },
    bill_id: { type: Types.ObjectId, ref: 'PurchaseInvoice' },
    debit_note_date: { type: Date, required: true },
...
debitNoteSchema.index({ company_id: 1, debit_note_date: -1 });
debitNoteSchema.index({ vendor_id: 1 });
